...
export default class RangeSlider2 extends ReactiveElement {
  constructor(props?: RangeSliderProps2) {
    super({
      shadowDOM: true,
      animations: {
